        ...
        directionsService.route(
            ...
            function(response, status) {
              if (status === 'OK') {
                ...
                window.alert(status +'Certifique-se que tenha inserido numero em ambos os endereços');
              }
            });
      }     
...
<nav class="col-md-2 offset-md-1 col-sm-4 col-12  container-fluid navbar-dark fixe-top" >
    <a class="navbar-brand" href=""id="LOGO"><img src="img/CARGO%20LOGO%20PRETO.png" width="100%" style=" width: 240px;
            height: 95px;"></a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarResponsive">
        <span class="navbar-toggler-icon"></span>
    </button>
  <a class="nav-link" href="https://www.cargocar.app/" id="HOME" style="font-size: 400px;">Home</a>
    </nav>
</nav>
...
<div class="container-fluid padding">
    <div class="row">
        <div class="col-md-4 offset-md-1 col-sm-4 col-10">
            <div class="card card-body">
                <form action="indexdesck.php#ancora" method="post"> 
                    <div class="form-group">
                        <label>Insira a quantidade de volumes</label>
    ...
    <!-  Galeria ->
    <div id="ancora"></div>
    <h1 class="text-center" >Valores e modalidades</h1>
      <p class="page-description text-center">Valores acessiveis e Logistica avançada </p>
      ...
      <tr>
        ...
        <th><div id="mostrar"><?php
            ...
            // echo $url;
                        ...
                        echo "<p style='color:#2E2E2E;display:inline;'> Distância :</p><p style='color:#2E2E2E;display:inline'> ". $kmcliente. "<br><br></p>";
                        echo "<p style='color:#2E2E2E;display:inline;'> Tempo estimado :</p><p style='color:#2E2E2E;display:inline'> ".$tempclient. "<br><br></p>";
    ...
    <thead>
      <tr>
        ...
        <th><div id="mostrar"><?php
                        ...
                        echo "<p style='color:#2E2E2E;display:inline;'> Distância :</p><p style='color:#2E2E2E;display:inline'> ". $kmcliente. "<br><br></p>";
                        echo "<p style='color:#2E2E2E;display:inline;'> Tempo estimado : $tempclient </p>";
                ?></div></th>
...
<!--- Connect -->
  ...
  <div class="fixed-bottom">
   <div id="wpp-btn-fixo" >
    <a href="https://api.whatsapp.com/send?phone=5511987440176">
